    ...
    <div className="p-4 md:p-6 pb-24">
      <div className="mx-auto max-w-3xl">
        ...
        <div className="flex items-center gap-3 mb-6">
          <button onClick={() => navigate('/app/clientes')} className="btn-ghost p-2">
            <ArrowLeft size={20} />
          </button>
          ...
          <div className="card p-6">
            <div className="grid gap-4 sm:grid-cols-2">
              <div>
                ...
                <input type="text" value={cep} onChange={e => setCep(maskCEP(e.target.value))}
        ...
        <div className="flex gap-3 mt-4 justify-end">
          <button onClick={() => navigate('/app/clientes')} className="btn-secondary">Cancelar</button>
