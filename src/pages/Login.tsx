    ...
    >
      <form onSubmit={handleSubmit} className="flex flex-col gap-6 animate-fade-in">
        ...
        <div className="flex flex-col items-center gap-3">
          <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-primary to-indigo-700 text-white shadow-xl shadow-primary/20">
