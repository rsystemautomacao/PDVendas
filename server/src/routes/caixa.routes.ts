...
import { abrirCaixaSchema, movimentacaoSchema, fecharCaixaSchema } from '../validators/caixa.validator';
...
router.put('/:id/fechar', validate(fecharCaixaSchema), caixaController.close);
